...
class SiteFooter extends HTMLElement {
    connectedCallback() {
        ...
        <style>
            ...
            .social-icons a:hover svg { fill: var(--champagne-gold); }
            .footer-bottom {
                text-align: center;
                margin-top: 60px;
                padding-top: 30px;
            ...
            .footer-bottom a { color: var(--champagne-gold); text-decoration: none; transition: color 0.3s; }
        ...
        // DYNAMICALLY LOAD THE SCRIPT AFTER HTML INJECTION TO GUARANTEE THE POPUP WORKS
