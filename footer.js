...
class SiteFooter extends HTMLElement {
    connectedCallback() {
        ...
        <style>
            ...
            .contact-form { 
                background: var(--bg-ivory); padding: 30px; border-radius: 8px;
                color: var(--text-dark); box-shadow: 0 10px 30px rgba(0,0,0,0.15); 
            }
            .form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 15px; }
            .form-group { margin-bottom: 15px; } 
            .form-group label { 
                display: block; font-size: 0.65rem; margin-bottom: 5px; 
            ...
            .form-group input[type="text"], .form-group input[type="tel"], .form-group input[type="email"], .form-group select, .form-group textarea {
                width: 100%; padding: 8px 0; border: none; border-bottom: 1px solid rgba(17, 26, 62, 0.2); 
